    ...
    <el-row class="cron-row">
      <el-tabs v-model="activeTabName" type="border-card">
        ...
        <el-tab-pane name="4">
          ...
          <day-of-month :tag="tag.dayOfMonth" :size="size" @day-of-month-change="changeDayOfMonth" />
        </el-tab-pane>
        <el-tab-pane name="5">
        ...
        <el-tab-pane name="6">
          ...
          <day-of-week :tag="tag.dayOfWeek" :size="size" @day-of-week-change="changeDayOfWeek" />
        </el-tab-pane>
        <el-tab-pane name="7">
        ...
        <el-tab-pane name="8">
          ...
          <div class="cell-div">
            ...
            <span style="margin-left: 5px;">{{ sample }}</span>
          </div>
          <h4>{{ $t('common.reference') }}</h4>
          <table>
            <thead>
              <tr>
                <td></td>
                <th>{{ $t('common.valTip') }}</th>
                <th>{{ $t('common.symbolTip') }}</th>
              </tr>
            </thead>
            <tr v-for="(item, index) in timeUnits" :key="index">
              <th>{{ item }}</th>
              <td>{{ vals[index] }}</td>
              <td>{{ symbols[index] }}</td>
            </tr>
  ...
  methods: {
    ...
    loadConst() {
      ...
      this.timeUnits = [
        ...
        this.$root.$t('hour.title'),
        this.$root.$t('dayOfMonth.title'),
        this.$t('month.title'),
